...
private:
    ...
    std::shared_ptr<CTreeActual> mTree;       ///< Tree we are displaying	//Changed from CTree to CTreeActual
    std::shared_ptr<CBasketActual> mBasket;   ///< Basket					//Changed from CBasket to CBasketActual
};
